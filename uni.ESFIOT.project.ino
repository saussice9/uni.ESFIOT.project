...
void updateMotorsSettings(uint8_t left_PWM, uint8_t right_PWM, motorDirection left_direction, motorDirection right_direction);
...
void updateMotorsSettings(uint8_t left_PWM, uint8_t right_PWM, motorDirection left_direction, motorDirection right_direction) {
  ...
  analogWrite(EN_A, right_PWM);
  analogWrite(EN_B, left_PWM);
