 ...
 * @details Controls buzzer functionality and stores musical melodies and note durations.
 */
 ...
 /**
  * @brief Includes the 'pitches.h' header file.
  * @details This header file provides definitions for common musical note frequencies, used by the buzzer.
  */
 #include <pitches.h>
